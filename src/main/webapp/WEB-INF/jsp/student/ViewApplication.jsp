      ...
      <div class="panel-body">
      	<div class="panel panel-primary">
     		<div class="panel-heading">Application Information</div>
      		<div class="panel-body">
      			<table class="table ">
      				<tr><td>Department</td><td>${application.program.department.name}</td></tr>
      				<tr><td>Program</td><td>${application.program.programName}</td></tr>
      				<tr><td>Term</td><td>${application.term}</td></tr>
      				<tr>
      					<td>Submitted On</td>
      					<td>
      				...
      				<tr><td>Current Status</td><td>${application.currentStatus}</td></tr>
      			</table>
      		</div>
   		</div>
   		<div class="panel panel-primary">
      		...
      		<label style="text-align: center;width: 100%">Personal Information</label>
      			...
      			<table class="table table-hover">
					...
					<table class="table table-hover">
		    			...
		    			<tbody>
		    				<tr>
		    					<c:forEach items="${application.additionalFieldValues}" var = "additionalFieldValue">
